package com.marcelocbasilio.projetocrudsingle.domain;
...
public class Cliente {
    ...
    public String toString() {
        ...
        sb.append(String.format("> [telefone] -> %s%n", tel));
        sb.append(String.format("> [endereço] -> %s%n", end));
        sb.append(String.format("> [número] -> %s%n", numero));
        sb.append(String.format("> [cidade] -> %s%n", cidade));
